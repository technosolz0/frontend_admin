...
export default function AddUserPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // TODO: Send formData to your API, e.g., await fetch('/api/users', { method: 'POST', body: JSON.stringify(formData) })
      setShowSuccess(true);
      ...
      <div className="flex-1 ml-64">
        ...
        >
          <div className="max-w-2xl mx-auto">
            <h1 className="text-3xl font-bold text-gray-800 mb-6 sm:text-4xl">Add New User</h1>
            <motion.div
