...
import { getReferralCode, updateReferralCode, AdminReferralCodeCreate } from '@/services/referralCodes';

export default function EditReferralCodePage() {
    ...
    useEffect(() => {
        const fetchCode = async () => {
            try {
                const data = await getReferralCode(parseInt(id));
                setFormData({
                    code: data.code,
                    name: data.name,
                    no_of_bookings: data.no_of_bookings,
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await updateReferralCode(parseInt(id), formData);
            setShowSuccess(true);
            setTimeout(() => {
            ...
            alert(error instanceof Error ? error.message : 'Failed to update referral code');
        } finally {
            ...
            <div className="flex-1 ml-64 text-black">
                ...
                >
                    <div className="max-w-2xl mx-auto">
                        <h1 className="text-3xl font-bold text-gray-800 mb-6 sm:text-4xl">Edit Referral Code</h1>
                        <motion.div
                        ...
                        >
                            <form onSubmit={handleSubmit}>
                                <motion.div custom={0} className="mb-6">
                                ...
                                <motion.div custom={1} className="mb-6">
